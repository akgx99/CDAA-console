...
namespace TPCDAA
{
    ...
    /// </summary>
    public class Jeu : IComparable<Jeu>
    {
        //TODO
        //etudier class Collections  Hashtable<Key,  Value>,  Dictionnary<Tkey,TValue> ,  ajouter des élements perso
        ...
        /// </summary>
        /// <param name="other">L'autre jeu à comparer</param>
